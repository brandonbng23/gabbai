...
import { parshaToString, calculateNumVerses } from './common.js';
...
function specialReadings2(parsha, hd, il, aliyot) {
    ...
    function handleSpecial(key) {
        ...
        if (special.haft && !specialHaft) {
            ...
            if (special.chabad) {
                chabad = cloneHaftara(special.chabad);
                reason.chabad = key;
            }
        }
...
export { specialReadings2 };
//# sourceMappingURL=specialReadings.js.map
